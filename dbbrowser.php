...
<html>
    <head>
        ...
        <style>
            .connection-manager__link,
            .connection-manager,
            .connection-tab-panel,
            .window-background__table,
            ...
            .connection-schema-block__filter {
                position: absolute;
                top: 10px;
                left: 10px;
                width: 230px;
            ...
            .connection-schema-block__filter-textfield {
                width: 100%;
                height: 100%;
            }
            .connection-tab-panel {
            ...
            .connection-schema-block__schema-tree {
                position: absolute;
                top: 45px;
                left: 0px;
                width: 250px;
            ...
            .connection-manager__header span {
                font-size: 20px;
                height: 30px;
                padding: 10px;
                font-weight: bold;
            ...
            .connection-manager__link-title {
            ...
            #sqlconnection-add-button {
                display: none;
                width: calc(50% - 3px);
            }
            .add #sqlconnection-add-button {
                display: inline-block;
            }
            #sqlconnection-update-button {
                display: none;
                width: calc(50% - 3px);
            }
            .update #sqlconnection-update-button {
                display: inline-block;
            }
            #sqlconnection-host-block {
                display: none;
            }
            .tcp-ip #sqlconnection-host-block {
                display: block;
            }
            #sqlconnection-socket-pipe-path-block {
                display: none;
            }
            .socket-pipe #sqlconnection-socket-pipe-path-block {
                display: block;
            }
            #sqlconnection-type {
                width: 100%;
            ...
            #sqlconnection-proxy-url-block {
                display: none;
            }
            .php-pdo-proxy #sqlconnection-proxy-url-block {
                display: block;
            }
            #sqlconnection-proxy-url {
                width: 100%;
            }
            .connection-manager__header {
                height: 60px;
            }
            .connection-manager__button {
                border: 1px solid #eee;
                padding: 10px;
                display: inline-block;
                cursor: pointer;
            }
            .connection-manager__button:hover {
                border: 1px solid #ddd;
                background: #eee;
            }
    ...
    <body>
        <script>
			...
			(function () {
					...
					v = function (e, t) {
						...
						function J() {
							clearTimeout($), $ = setTimeout(function () {
								b && (n.style.cssText = b, b = ""), t.renderer.$keepTextAreaAtCursor == null && (t.renderer.$keepTextAreaAtCursor = !0, t.renderer.$moveTextAreaToCursor())
							}, 0)
						}
						...
						r.addListener(n, "compositionstart", R), r.addListener(n, "compositionupdate", U), r.addListener(n, "keyup", V), r.addListener(n, "keydown", X), r.addListener(n, "compositionend", z), this.getElement = function () {
							...
							t.renderer.$keepTextAreaAtCursor && (t.renderer.$keepTextAreaAtCursor = null), clearTimeout($), i.isWin && r.capture(t.container, h, J)
				...
				var y = function (e, t) {
					...
					this.canvas = r.element, this.$markerFront = new u(this.content), this.$cursorLayer = new f(this.content), this.$horizScroll = !1, this.$vScroll = !1, this.scrollBar = this.scrollBarV = new c(this.container, this), this.scrollBarH = new l(this.container, this), this.scrollBarV.addEventListener("scroll", function (e) {
						...
						v: 0,
						h: 0
					}, this.$keepTextAreaAtCursor = !m.isIOS, this.$loop = new h(this.$renderChanges.bind(this), this.container.ownerDocument.defaultView), this.$loop.schedule(this.CHANGE_FULL), this.updateCharacterSize(), this.setPadding(4), s.resetOptions(this), s._emit("renderer", this)
				};
				(function () {
				...
				}, t.Range = s, t.Editor = o, t.EditSession = u, t.UndoManager = a, t.VirtualRenderer = f, t.version = "1.4.2"
			});            
            (function() {
            ...
            function fnAddSQLConnection(sType, sMethod, sDriver, sName, sUser, sHost, sSocket, sPassword)
            {
                ...
                for (var iIndex in aSavedConnections) {
                    if (aSavedConnections[iIndex]['sType'] == sType
                        ...
                        && aSavedConnections[iIndex]['sName'] == sName
                        && aSavedConnections[iIndex]['sUser'] == sUser
                        && aSavedConnections[iIndex]['sHost'] == sHost
                        && aSavedConnections[iIndex]['sSocket'] == sSocket) {
                    
                        if (aSavedConnections[iIndex]['sPassword'] != sPassword) {
                            aSavedConnections[iIndex]['sPassword'] = sPassword;
                        }
                        return;
                    }
                }
                
                aSavedConnections.push({
                    sType: sType,
                    sMethod: sMethod,
                    sDriver: sDriver,
                    sName: sName,
                ...
                fnShowSQLConnectionButton(aSavedConnections.length-1);
            ...
            function fnUpdateSQLConnection(iIndex, sType, sMethod, sDriver, sName, sUser, sHost, sSocket, sPassword)
            {
                ...
                aSavedConnections[iIndex]['sSocket'] = sSocket;
                aSavedConnections[iIndex]['sPassword'] = sPassword;
                fnUpdateSQLConnectionButton(iIndex);
                localStorage['sSavedConnections'] = JSON.stringify(aSavedConnections);
            }
            ...
            function fnSelectMethod(sMethod)
            {
                ...
                if (sMethod == "socket-pipe") {
                    oSQLConnectionWindow.classList.add('socket-pipe');
                    oSQLConnectionWindow.classList.remove('tcp-ip');
                }
            }
            ...
            function fnSelectType(sType)
            {
                ...
                if (sType == "php-pdo-proxy") {
                    oSQLConnectionWindow.classList.add('php-pdo-proxy');
                }
            }
            ...
            function fnOnAddSQLConnectionWindow()
            {
                ...
                fnAddSQLConnection(
                    ...
                    document.getElementById("sqlconnection-driver").value,
                    document.getElementById("sqlconnection-name").value,
                    document.getElementById("sqlconnection-user").value,
                    document.getElementById("sqlconnection-host").value,
                    document.getElementById("sqlconnection-socket-pipe-path").value,
                    document.getElementById("sqlconnection-password").value                        
                );
            }
            ...
            function fnShowSQLNewConnectionWindow()
            {
                ...
                oSQLConnectionWindow.classList.remove('update');
                oSQLConnectionWindow.classList.add('add');
                document.getElementById("sqlconnection-type").value = "php-pdo";
                document.getElementById("sqlconnection-method").value = "tcp-ip";
                document.getElementById("sqlconnection-driver").value = "mysql";
                document.getElementById("sqlconnection-name").value = "";
                document.getElementById("sqlconnection-user").value = "";
                document.getElementById("sqlconnection-host").value = "";
                document.getElementById("sqlconnection-socket-pipe-path").value = "";
                document.getElementById("sqlconnection-password").value = "";
                fnSelectType("php-pdo");
                fnSelectMethod("tcp-ip");
            }
            ...
            function fnShowSQLConnectionWindow(iIndex)
            {
                ...
                fnSetConnectionsActiveTab(oHomeTab);
                oSQLConnectionWindow.classList.add('show');
                oSQLConnectionWindow.classList.remove('add');
                oSQLConnectionWindow.classList.add('update');
                document.getElementById("sqlconnection-type").value = aSavedConnections[iIndex]['sType'];
                document.getElementById("sqlconnection-method").value = aSavedConnections[iIndex]['sMethod'];
                document.getElementById("sqlconnection-driver").value = aSavedConnections[iIndex]['sDriver'];
                document.getElementById("sqlconnection-name").value = aSavedConnections[iIndex]['sName'];
                document.getElementById("sqlconnection-user").value = aSavedConnections[iIndex]['sUser'];
                document.getElementById("sqlconnection-host").value = aSavedConnections[iIndex]['sHost'];
                document.getElementById("sqlconnection-socket-pipe-path").value = aSavedConnections[iIndex]['sSocket'];
                document.getElementById("sqlconnection-password").value = aSavedConnections[iIndex]['sPassword'];
                fnSelectType(aSavedConnections[iIndex]['sType']);
                fnSelectMethod(aSavedConnections[iIndex]['sMethod']);
            }
            ...
            function fnCreateSQLConnectionButtons()
            {
                ...
                if (localStorage['sSavedConnections']) {
                    try {
                        ...
                        for (iIndex in aSavedConnections) {
                            if (!aSavedConnections[iIndex]['bIsDeleted']) {
                                fnShowSQLConnectionButton(iIndex);
                            }
                        }
                    } catch (oException) {
                        aSavedConnections = [];
                        alert('Error while parsing saved connections: '+oException);
                    }
                }            
            }
            ...
            function fnUpdateSQLConnectionButton(iConnectionIndex)
            {
                ...
                oElement.querySelector(".connection-manager__link-user").innerText = aSavedConnections[iConnectionIndex]['sUser'];
                oElement.querySelector(".connection-manager__link-host").innerText = aSavedConnections[iConnectionIndex]['sHost'];
            }
            ...
            function fnShowSQLConnectionButton(iConnectionIndex)
            {
                ...
                document.querySelector(".connection-manager").innerHTML +=
                    '<div class="connection-manager__link" \
                        ...
                        <div class="connection-manager__link-user">\
                            '+aSavedConnections[iConnectionIndex]['sUser']+'\
                        </div>\
                        <div class="connection-manager__link-host">\
                            '+aSavedConnections[iConnectionIndex]['sHost']+'\
                        </div>\
                    </div>';
            }
            ...
            function fnSetActiveTab(oTarget, sActiveTabSelector, sActiveBodySelector)
            {
                ...
                var oActiveTabBody = document.querySelector(sActiveBodySelector);
                if (oActiveTabBody) {
                    oActiveTabBody.classList.remove('active');
                }
                var oTargetTabBody = document.getElementById(oTarget.getAttribute('target'));
                if (oTargetTabBody) {
                    oTargetTabBody.classList.add('active');
                }                
            }
            ...
            function fnParentOrElementWithClass(oTarget, sClassName)
            {
                ...
                if (oTarget.parentElement) {
                    return fnParentOrElementWithClass(oTarget.parentElement, sClassName);
                }
            ...
            function fnDownloadFile(sFileName, sFileContent)
            {
                ...
                oDownloadLink.innerHTML = "";
                oDownloadLink.id = "download-link";
                
                if (window.webkitURL != null) {
                    oDownloadLink.href = window.webkitURL.createObjectURL(oTextFileAsBlob);
                } else {
                    oDownloadLink.href = window.URL.createObjectURL(oTextFileAsBlob);
                    oDownloadLink.onclick = function() {
            ...
            function fnExportConnectionsAsCSV()
            {
                ...
                for (var iRowIndex in aSavedConnections) {
                    if (aSavedConnections[iRowIndex]["bIsDeleted"]) {
                        continue;
                    }
                    ...
                    for (var iColumnIndex in aSavedConnections[iRowIndex]) {
                        ...
                        sExportString += '"'+aSavedConnections[iRowIndex][iColumnIndex].toString().replace(/"/, '\\"')+'",';
                    }
                    
                    sExportString = sExportString.replace(/,$/, "\n");
                    if (!bColumns) {
                        sColumns = sColumns.replace(/,$/, "\n");
                        sExportString = sColumns + sExportString;
                        bColumns = true;
                    }
                }
            ...
            function fnUpdateSynchronizationURLListInWindow()
            {
                ...
                if (localStorage['sSettings']) {
                    try {
                        ...
                        var oListBlock = $("#synchronization-options-window-list-block");

                        oListBlock.innerHTML = '';
                        for (var iIndex in oSettings['aSyncURLs']) {
                            oListBlock.innerHTML += '\n\
                                <div class="window__list-row-block" id="synchronization-options-url-'+iIndex+'">\
                                    <input type="text" placeholder="http://example.com/path/file.php" value="'+oSettings['aSyncURLs'][iIndex]+'">\
                                    <button class="window__list-row-block__delete-button" url-id="'+iIndex+'">&Cross;</button>\
                                </div>\
                            ';
                        }
                    } catch (oException) {
            ...
            document.onclick = function(oEvent)
            {
                ...
                if (oEvent.target.id == "connection-manager-export-as-json") {
                    fnExportConnectionsAsJSON();
                    return;
                }
                
                if (oEvent.target.classList.contains('add-connection-button')) {
                    fnShowSQLNewConnectionWindow();
                    return;
                }

                if (oEvent.target.id == "sqlconnection-update-button") {
                    oSQLConnectionWindow.classList.remove('show');
                    fnOnUpdateSQLConnectionWindow();
                    return;
                }

                if (oEvent.target.id == "sqlconnection-add-button") {
                    oSQLConnectionWindow.classList.remove('show');
                    fnOnAddSQLConnectionWindow();
                    return;
                }

                if (oEvent.target.id == "sqlconnection-cancel-button") {
                    oSQLConnectionWindow.classList.remove('show');
                    return;
                }
                ...
                if (oEvent.target.classList.contains('connections-tab')) {
                    fnSetConnectionsActiveTab(oEvent.target);
                    return;
                }
                ...
                if (oEvent.target.classList.contains('connection-tab')) {
                    fnSetActiveTab(oEvent.target, '.connection-tab.active', '.connection-tab-body.active');
                    return;
                }
                
                if (oEvent.target.classList.contains('connection-tab-close-button')
                    && oEvent.target.parentNode.classList.contains('connection-tab')) {
                    fnCloseTab(oEvent.target.parentNode, '.connection-tab');
                    return;
                }
            ...
            document.onchange = function(oEvent)
            {
                ...
                if (oEvent.target.id == 'sqlconnection-method') {
                    fnSelectMethod(oEvent.target.value);
                    return;
                }
                
                if (oEvent.target.id == 'sqlconnection-driver') {
            ...
            var oHomeTab;
            var iConnectionManagerConnectionIndex;
            var oSQLConnectionWindow;
            var oSynchronizationOptionsWindow;
            var aSavedConnections = [];
            var aConnections = [];
            var aSavedConnections = [];
            var oSettings = {
                aSyncURLs: []
        ...
        <div class="connections-tab-bodies"> 
            
            <div class="connections-tab-body active" id="home-tab">
                ...
                <div class="window-background__table" id="sqlconnection-window">
                    <div class="window-background__cell">
                        <div class="window__block">
                            <div class="window__field-block">
                                <label>
                                    <b>Name</b><br>
                                    <input type="text" id="sqlconnection-name" placeholder='Connection name'>
                                </label>
                            </div>
                            <div class="window__field-block">
                                <label>
                                    <b>Connection methods</b><br>
                                    <select id="sqlconnection-type">
                                        <option value="php-pdo">PHP PDO</option>
                                        <option value="php-pdo-proxy">PHP PDO proxy</option>
                            ...
                            <div class="window__field-block">
                                <label>
                                    <select id="sqlconnection-method">
                                        <option value="tcp-ip">TCP/IP</option>
                                        <option value="socket-pipe">Socket/Pipe</option>
                                    </select>
                                </label>
                            </div>
                            <div class="window__field-block">
                                <label>
                                    <b>Connection driver</b><br>
                                    <select id="sqlconnection-driver">
                                        <option value="mysql">MySQL</option>
                                        <option value="sqlite">SQLite</option>
                                    </select>
                                </label>
                            </div>
                            <div class="window__field-block" id="sqlconnection-proxy-url-block">
                                <label>
                                    <b>Proxy URL</b><br>
                                    <input type="text" id="sqlconnection-proxy-url" placeholder='http://server.org/path/file.php'>
                                </label>
                            </div>
                            <div class="window__field-block" id="sqlconnection-host-block">
                                <label>
                                    <b>Host</b><br>
                                    <input type="text" id="sqlconnection-host" placeholder='127.0.0.1:3306'>
                                </label>
                            </div>
                            <div class="window__field-block" id="sqlconnection-socket-pipe-path-block">
                                <label>
                                    <b>Socket path</b><br>
                                    <input type="text" id="sqlconnection-socket-pipe-path" placeholder='/path/to/socket'>
                                </label>
                            </div>
                            <div class="window__field-block">
                                <label>
                                    <b>User</b><br>
                                    <input type="text" id="sqlconnection-user" placeholder='login'>
                                </label>
                            </div>
                            <div class="window__field-block">
                                <label>
                                    <b>Password</b><br>
                                    <input type="password" id="sqlconnection-password">
                                </label>
                            </div>
                            <div class="window__field-block">
                                <input type="submit" id="sqlconnection-cancel-button" value="Cancel">
                                <input type="submit" id="sqlconnection-add-button" value="Add">
                                <input type="submit" id="sqlconnection-update-button" value="Update">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="connections-tab-body" id="connection-9999">
                ...
                <div class="connection-tab-panel">
                    <div class="connection-tab active" target="connection-1-query-1">
                        Query <a class="connection-tab-close-button">&Cross;</a>
                    </div>
                    <div class="connection-tab" target="connection-1-table-create-1">
                        Table create <a class="connection-tab-close-button">&Cross;</a>
                    </div>
                </div>
                <div class="connection-tab-bodies">
